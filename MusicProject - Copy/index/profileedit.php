...
<?php
    ...
    include('connect.php');
    $sql = "UPDATE user SET UserName ='$username', UserPassword ='$userpassword', FullName ='$fullname', UserImage = '$user_image', CardNumber ='$card_number', PhoneNumber='$phone_number', Address ='$address', Email ='$email', IDNumber ='$id_number' WHERE UserID ='$id'";
